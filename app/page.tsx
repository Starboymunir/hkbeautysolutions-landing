...
export default function Home() {
  ...
  return (
    <main className="bg-[#FFFBF8] text-[#2D2626] overflow-x-hidden">
      {/* Cursor follower */}
      <div 
        className="fixed w-4 h-4 bg-[#E8A4B8] rounded-full pointer-events-none z-50 mix-blend-difference transition-transform duration-100 hidden lg:block"
        style={{ 
      ...
      <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <a href="#" className="text-2xl font-light tracking-[0.3em] text-[#2D2626]">
            BEAUTY<span className="text-[#D4919E]">.</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-12">
            {['About', 'Services', 'Products', 'Contact'].map((item) => (
              <a 
                ...
                className="text-sm tracking-widest hover:text-[#D4919E] transition-colors relative group"
              >
                {item}
                <span className="absolute -bottom-1 left-0 w-0 h-px bg-[#D4919E] group-hover:w-full transition-all duration-300" />
              </a>
            ))}
          </div>
      ...
      <section className="min-h-screen relative flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-32 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="overflow-hidden">
              <p className="text-[#D4919E] tracking-[0.4em] text-sm animate-slideUp">
                BEAUTY SOLUTIONS HK
              </p>
            </div>
            ...
            <div className="overflow-hidden">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-extralight leading-[0.9] animate-slideUp animation-delay-200">
                Where
                <br />
                <span className="italic text-[#D4919E]">ideas</span>
                <br />
                meet
                <br />
            ...
            <div className="overflow-hidden">
              <p className="text-lg text-[#6B5B5B] max-w-md animate-slideUp animation-delay-400">
            ...
            <div className="flex items-center gap-8 animate-slideUp animation-delay-600">
              ...
              >
                <span className="w-16 h-16 rounded-full border-2 border-[#D4919E] flex items-center justify-center group-hover:bg-[#D4919E] transition-all duration-300">
          ...
          <div className="relative h-[600px] hidden lg:block">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-[#F5D6DC] rounded-full flex items-center justify-center animate-pulse-slow">
              <span className="text-4xl font-light text-[#D4919E]">✦</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
          <div className="w-px h-16 bg-gradient-to-b from-transparent via-[#D4919E] to-transparent animate-pulse" />
        </div>
      </section>

      {/* Stats bar - Horizontal scroll on mobile */}
      <section className="py-16 border-y border-[#F0E4E4]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
            {[
              ...
              <div key={i} className="text-center group cursor-default">
                <div className="text-4xl md:text-5xl font-extralight text-[#D4919E] group-hover:scale-110 transition-transform duration-300">
                  <Counter end={stat.number} suffix={stat.suffix} />
                </div>
                <p className="text-sm tracking-widest text-[#8B7B7B] mt-2">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 space-y-8">
              <p className="text-[#D4919E] tracking-[0.4em] text-sm">WHO WE ARE</p>
              <h2 className="text-4xl md:text-5xl font-extralight leading-tight">
                One Partner,
                <br />
                <span className="italic text-[#D4919E]">Multiple</span>
                <br />
                Pathways
              </h2>
            </div>
            ...
            <div className="lg:col-span-7 space-y-8">
              <p className="text-xl text-[#6B5B5B] leading-relaxed">
              ...
              <p className="text-[#8B7B7B] leading-relaxed">
              ...
              <div className="flex items-center gap-6 pt-8">
                <div className="w-20 h-px bg-[#D4919E]" />
                <p className="text-sm tracking-widest text-[#8B7B7B]">
      ...
      <section id="services" className="py-32 bg-[#FAF5F3]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <p className="text-[#D4919E] tracking-[0.4em] text-sm mb-4">WHAT WE DO</p>
            <h2 className="text-4xl md:text-6xl font-extralight">
              Our <span className="italic text-[#D4919E]">expertise</span>
            </h2>
          </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      <span className={`text-5xl font-extralight transition-colors duration-300 ${
                        activeService === index ? 'text-[#D4919E]' : 'text-[#E8D8D8]'
                      }`}>
                        0{index + 1}
                      </span>
                      <div>
                        <h3 className={`text-xl md:text-2xl font-light transition-colors duration-300 ${
                          activeService === index ? 'text-[#D4919E]' : ''
                        }`}>
                          {service.title}
                        </h3>
                        <p className={`text-sm text-[#8B7B7B] mt-1 transition-all duration-300 ${
                    ...
                    <svg 
                      className={`w-6 h-6 transition-all duration-300 ${
                        activeService === index ? 'rotate-45 text-[#D4919E]' : 'text-[#C8B8B8]'
                      }`} 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                ...
                {services.map((service, index) => (
                  ...
                  >
                    <Image
                      ...
                      className="object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#D4919E]/30 to-transparent" />
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="products" className="py-32">
        <div className="max-w-7xl mx-auto px-6 mb-16">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            <div>
              <p className="text-[#D4919E] tracking-[0.4em] text-sm mb-4">CATEGORIES</p>
              <h2 className="text-4xl md:text-6xl font-extralight">
                Product <span className="italic text-[#D4919E]">range</span>
              </h2>
            </div>
            <p className="text-[#8B7B7B] max-w-md">
      ...
      <section className="py-32 bg-[#2D2626] text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          {/* Header */}
          <div className="text-center mb-20">
            <p className="text-[#D4919E] tracking-[0.4em] text-sm mb-4">OUR BRANDS</p>
            <h2 className="text-4xl md:text-6xl font-extralight leading-tight">
              Brands we&apos;ve <span className="italic text-[#D4919E]">created</span>
            </h2>
            <p className="text-[#A89898] mt-6 max-w-2xl mx-auto">
          ...
          <div className="mb-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-[#A89898] text-lg leading-relaxed">
                ...
                <div className="flex flex-wrap gap-3">
                  {['Temporary Tattoos', 'Amazon Bestseller', 'Event Services'].map((tag, i) => (
                    <span key={i} className="px-4 py-2 border border-[#4A4040] rounded-full text-sm text-[#D4919E]">
                      {tag}
                    </span>
                  ))}
                </div>
            ...
            <div className="group">
              ...
              <div className="flex flex-wrap gap-2">
                {['Beauty Tools', 'Skincare Devices', 'Self-Care'].map((tag, i) => (
                  <span key={i} className="px-3 py-1 border border-[#4A4040] rounded-full text-xs text-[#D4919E]">
                    {tag}
                  </span>
                ))}
              </div>
      ...
      <section className="py-24 bg-[#FAF5F3]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-[#D4919E] tracking-[0.4em] text-sm mb-4">TRUSTED PARTNERS</p>
            <h2 className="text-3xl md:text-4xl font-extralight">
              We work with <span className="italic text-[#D4919E]">industry leaders</span>
            </h2>
          </div>
          ...
          <div className="mt-16 flex flex-wrap justify-center items-center gap-6">
            <span className="text-sm text-[#A89898] tracking-wider">ALSO TRUSTED BY</span>
            <span className="w-12 h-px bg-[#D4919E]/40" />
            {['Sephora', 'Swire'].map((partner, index) => (
              <span 
                key={index}
                className="text-lg font-light text-[#6B5B5B] hover:text-[#D4919E] transition-colors cursor-default"
              >
                {partner}
              </span>
            ))}
      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <p className="text-[#D4919E] tracking-[0.4em] text-sm mb-4">GLOBAL PRESENCE</p>
            <h2 className="text-4xl md:text-6xl font-extralight">
              We operate <span className="italic text-[#D4919E]">worldwide</span>
            </h2>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-8">
            {[
              ...
              <div 
                key={index}
                className="group relative px-8 py-6 border border-[#F0E4E4] hover:border-[#D4919E] hover:bg-[#FDF8F6] transition-all duration-300 rounded-full cursor-default"
              >
                <div className="flex items-center gap-3">
                  <span className="text-2xl">{location.flag}</span>
                  <div>
                    <p className="font-light">{location.country}</p>
                    <p className="text-xs text-[#8B7B7B]">{location.role}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-[#F0E4E4] rounded-full opacity-30" />
        
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          {/* Header */}
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-20">
            <div>
              <p className="text-[#D4919E] tracking-[0.4em] text-sm mb-4">TESTIMONIALS</p>
              <h2 className="text-4xl md:text-6xl font-extralight leading-tight">
                Voices of<br />
                <span className="italic text-[#D4919E]">partnership</span>
              </h2>
            </div>
            <p className="text-[#8B7B7B] max-w-md mt-6 lg:mt-0 font-light">
          ...
          <div className="mb-16">
            <div className="relative bg-[#2D2626] text-white rounded-[3rem] p-12 md:p-16 overflow-hidden">
              ...
              <div className="absolute -top-10 -left-10 text-[300px] font-serif text-[#D4919E] opacity-10 leading-none select-none">
                &ldquo;
              </div>
              <div className="relative z-10 grid lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#D4919E] to-[#E8B4B8] flex items-center justify-center text-white text-xl font-light">
                      DL
                    </div>
                    <div>
                      <p className="text-xl font-light">David Liu</p>
                      <p className="text-[#A89898]">Founder, Australian Skincare Brand</p>
                    </div>
                  </div>
                </div>
                <div className="hidden lg:flex items-center justify-center">
                  <div className="w-32 h-32 border border-[#D4919E]/30 rounded-full flex items-center justify-center">
                    <div className="w-24 h-24 border border-[#D4919E]/50 rounded-full flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 group">
              <div className="h-full border border-[#F0E4E4] hover:border-[#D4919E] rounded-3xl p-8 transition-all duration-500 hover:shadow-xl hover:shadow-[#D4919E]/5 bg-white/50 backdrop-blur-sm">
                <div className="flex gap-1 mb-6">
                  {[...Array(5)].map((_, i) => (
                    <span key={i} className="text-[#D4919E]">★</span>
                  ))}
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#F8E8E8] flex items-center justify-center text-[#D4919E] font-medium group-hover:bg-[#D4919E] group-hover:text-white transition-colors">
                    SK
                  </div>
                  <div>
                    <p className="font-medium text-[#2D2626]">Sarah Kim</p>
                    <p className="text-sm text-[#8B7B7B]">Procurement Manager, Korean Beauty Retailer</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="h-full border border-[#F0E4E4] hover:border-[#D4919E] rounded-3xl p-8 transition-all duration-500 hover:shadow-xl hover:shadow-[#D4919E]/5 bg-white/50 backdrop-blur-sm">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#F8E8E8] flex items-center justify-center text-[#D4919E] text-sm font-medium group-hover:bg-[#D4919E] group-hover:text-white transition-colors">
                    MR
                  </div>
                  <div>
                    <p className="font-medium text-[#2D2626] text-sm">Michael Reynolds</p>
                    <p className="text-xs text-[#8B7B7B]">CEO, US E-commerce Brand</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="h-full border border-[#F0E4E4] hover:border-[#D4919E] rounded-3xl p-8 transition-all duration-500 hover:shadow-xl hover:shadow-[#D4919E]/5 bg-white/50 backdrop-blur-sm">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#8B7B7B]">Events Director, Hong Kong</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-2 lg:col-span-4 group">
              <div className="border border-[#F0E4E4] hover:border-[#D4919E] rounded-3xl p-8 md:p-12 transition-all duration-500 hover:shadow-xl hover:shadow-[#D4919E]/5 bg-gradient-to-r from-[#FDF8F6] to-white">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    <div className="flex gap-1 mb-6">
                      {[...Array(5)].map((_, i) => (
                        <span key={i} className="text-[#D4919E] text-xl">★</span>
                      ))}
                    </div>
                  ...
                  <div className="flex items-center gap-4 md:justify-end">
                    <div>
                      ...
                      <p className="text-sm text-[#8B7B7B] md:text-right">Supply Chain Director, European Retailer</p>
                    </div>
                    <div className="w-14 h-14 rounded-full bg-[#F8E8E8] flex items-center justify-center text-[#D4919E] font-medium group-hover:bg-[#D4919E] group-hover:text-white transition-colors">
                      AN
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20">
            ...
            <div className="space-y-12">
              <div>
                <p className="text-[#D4919E] tracking-[0.4em] text-sm mb-4">GET IN TOUCH</p>
                <h2 className="text-4xl md:text-6xl font-extralight leading-tight">
                  Let&apos;s create
                  <br />
                  something
                  <br />
                  <span className="italic text-[#D4919E]">beautiful</span>
                </h2>
              </div>

              <div className="space-y-6">
                <div className="flex items-center gap-4 group cursor-pointer">
                  <div className="w-12 h-12 rounded-full border border-[#E8D8D8] flex items-center justify-center group-hover:border-[#D4919E] group-hover:bg-[#D4919E]/10 transition-all">
                    <svg className="w-5 h-5 text-[#D4919E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-sm text-[#8B7B7B]">Email</p>
                ...
                <div className="flex items-center gap-4 group cursor-pointer">
                  ...
                  <div>
                    <p className="text-sm text-[#8B7B7B]">WhatsApp</p>
                ...
                <div className="flex items-center gap-4 group cursor-pointer">
                  <div className="w-12 h-12 rounded-full border border-[#E8D8D8] flex items-center justify-center group-hover:border-[#D4919E] group-hover:bg-[#D4919E]/10 transition-all">
                    <svg className="w-5 h-5 text-[#D4919E]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <p className="text-sm text-[#8B7B7B]">WeChat</p>
            ...
            <div className="bg-[#FAF5F3] p-8 md:p-12 rounded-[2rem]">
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm text-[#8B7B7B] mb-2">Name</label>
                    <input 
                      type="text" 
                      className="w-full px-0 py-3 bg-transparent border-b border-[#E8D8D8] focus:border-[#D4919E] outline-none transition-colors"
                      placeholder="Your name"
                    />
                  </div>
                  <div>
                    <label className="block text-sm text-[#8B7B7B] mb-2">Company</label>
                    <input 
                      type="text" 
                      className="w-full px-0 py-3 bg-transparent border-b border-[#E8D8D8] focus:border-[#D4919E] outline-none transition-colors"
                ...
                <div>
                  <label className="block text-sm text-[#8B7B7B] mb-2">Email</label>
                  <input 
                    type="email" 
                    className="w-full px-0 py-3 bg-transparent border-b border-[#E8D8D8] focus:border-[#D4919E] outline-none transition-colors"
                ...
                <div>
                  <label className="block text-sm text-[#8B7B7B] mb-2">Interest</label>
                  <select className="w-full px-0 py-3 bg-transparent border-b border-[#E8D8D8] focus:border-[#D4919E] outline-none transition-colors cursor-pointer">
                ...
                <div>
                  <label className="block text-sm text-[#8B7B7B] mb-2">Message</label>
                  <textarea 
                    rows={4}
                    className="w-full px-0 py-3 bg-transparent border-b border-[#E8D8D8] focus:border-[#D4919E] outline-none transition-colors resize-none"
                ...
                <button 
                  type="submit"
                  className="w-full py-4 bg-[#2D2626] text-white tracking-widest text-sm hover:bg-[#D4919E] transition-colors duration-300 rounded-full mt-8"
                >
                  Send Message
                </button>
              </form>
      ...
      {/* Footer - Minimal */}
      <footer className="py-12 border-t border-[#F0E4E4]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-6">
              <a href="https://www.linkedin.com/company/104444059/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#E8D8D8] flex items-center justify-center hover:border-[#D4919E] hover:bg-[#D4919E]/10 transition-all">
                <svg className="w-4 h-4 text-[#8B7B7B]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              <a href="https://wa.me/85263671752" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#E8D8D8] flex items-center justify-center hover:border-[#D4919E] hover:bg-[#D4919E]/10 transition-all">
                <svg className="w-4 h-4 text-[#8B7B7B]" fill="currentColor" viewBox="0 0 24 24">
